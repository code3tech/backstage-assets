...
/**
 * A phrase by which an Individual is known and distinguished from other Individuals. An IndividualName is an informal way
 * of identifying an Individual. The model allows only one IndividualName for an Individual. This is a restriction
 * compared to TMF/NGOSS SID model which allows for multiple.
 * :
 * Restriction of {http://amdocs/pbg-portfolio/commonbusinessentities/types-unqualified/v1}IndividualName,
 * Derived from PIM entity IndividualName in the domain party.
 * 
 * <p>Classe Java de IndividualName complex type.
 * 
 ...
 *           &lt;/simpleType&gt;
 *         &lt;/element&gt;
 *         &lt;element name="preferredGivenName" minOccurs="0"&gt;
 *           &lt;simpleType&gt;
 *             &lt;restriction base="{http://www.w3.org/2001/XMLSchema}string"&gt;
 *               &lt;maxLength value="127"/&gt;
 *               &lt;whiteSpace value="collapse"/&gt;
...
public class IndividualName2 {
    ...
    /**
     * Obtém o valor da propriedade preferredGivenName.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * Define o valor da propriedade preferredGivenName.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
    ...
    /**
     * Obtém o valor da propriedade salutation.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * Define o valor da propriedade salutation.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
