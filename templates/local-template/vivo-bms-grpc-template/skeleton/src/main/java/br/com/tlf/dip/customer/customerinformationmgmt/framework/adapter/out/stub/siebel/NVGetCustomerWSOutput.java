 ...
 *         &lt;element ref="{http://www.siebel.com/xml/NVGetCustomerOut}NVGetCustomerOut"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "NVGetCustomerWS_Output", namespace = "http://siebel.com/CustomUI")
@ToString
public class NVGetCustomerWSOutput {

    @XmlElement(name = "Error_spcCode", namespace = "http://siebel.com/CustomUI", required = true)
    protected String errorSpcCode;
    @XmlElement(name = "Error_spcMessage", namespace = "http://siebel.com/CustomUI", required = true)
    protected String errorSpcMessage;
    @XmlElement(name = "NVGetCustomerOut", namespace = "http://www.siebel.com/xml/NVGetCustomerOut",  required = true)
    protected NVGetCustomerOut nvGetCustomerOut;

    /**
     * Obtém o valor da propriedade errorSpcCode.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * Define o valor da propriedade errorSpcCode.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
    ...
    /**
     * Obtém o valor da propriedade errorSpcMessage.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * Define o valor da propriedade errorSpcMessage.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
