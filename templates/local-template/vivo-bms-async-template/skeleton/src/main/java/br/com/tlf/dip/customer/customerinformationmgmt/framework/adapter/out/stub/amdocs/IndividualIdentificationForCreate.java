...
/**
 * The information used to create a IndividualIdentification.
 * :
 * Restriction of {http://amdocs/pbg-portfolio/commonbusinessentities/types-unqualified/v1}IndividualIdentification,
 * Derived from PIM entity IndividualIdentification in the domain party.
 * 
 * <p>Classe Java de IndividualIdentificationForCreate complex type.
 * 
 * <p>O seguinte fragmento do esquema especifica o conteúdo esperado contido dentro desta classe.
 * 
 * <pre>
 * &lt;complexType name="IndividualIdentificationForCreate"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "IndividualIdentificationForCreate", propOrder = {
    "isDefault",
    "issuingCountry",
    "validityEnd",
    "validityStart"
...
@XmlSeeAlso({
    DriversLicenseIdentificationForCreate.class,
    NationalIdentityCardIdentificationForCreate.class,
    OtherIndividualIdentificationForCreate.class,
    PassportIdentificationForCreate.class,
    SocialSecurityNumberIdentificationForCreate.class
})
public abstract class IndividualIdentificationForCreate {
