 ...
 * 
 * <p>Classe Java de PrimaryContactForCreate complex type.
 * 
 * <p>O seguinte fragmento do esquema especifica o conteúdo esperado contido dentro desta classe.
 * 
 * <pre>
 * &lt;complexType name="PrimaryContactForCreate"&gt;
 *   &lt;complexContent&gt;
 *     &lt;extension base="{http://amdocs/tef-vivo/customerprofile/types/v1}PrimaryIndividualRoleForCreate"&gt;
 *       &lt;sequence&gt;
 ...
 *                 &lt;sequence&gt;
 *                   &lt;element name="contactMean" type="{http://amdocs/tef-vivo/commonbusinessentities-common/types/v1}ContactMediumID" maxOccurs="unbounded"/&gt;
 *                 &lt;/sequence&gt;
 *               &lt;/restriction&gt;
 *             &lt;/complexContent&gt;
 *           &lt;/complexType&gt;
...
@XmlType(name = "PrimaryContactForCreate", propOrder = {
    "contactMeans",
    "locatedAt",
    "role"
})
public class PrimaryContactForCreate
    extends PrimaryIndividualRoleForCreate
{

    @XmlElement(required = true)
    protected PrimaryContactForCreate.ContactMeans contactMeans;
     ...
     * @return
     *     possible object is
     *     {@link PrimaryContactForCreate.ContactMeans }
     *     
     */
    public PrimaryContactForCreate.ContactMeans getContactMeans() {
        return contactMeans;
    }
     ...
     *     
     */
    public void setContactMeans(PrimaryContactForCreate.ContactMeans value) {
    ...
    public static class ContactMeans {
        ...
        @XmlElement(required = true)
        protected List<ContactMediumID> contactMean;
         ...
         * 
         */
        public List<ContactMediumID> getContactMean() {
            if (contactMean == null) {
                contactMean = new ArrayList<ContactMediumID>();
            }
