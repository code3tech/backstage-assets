...
@XmlType(name = "PostalContactBillingAddress", namespace = "http://amdocs/tef-vivo/billingaccountmanagement/types/v1", propOrder = {
    "additionalName",
    "city",
    "country",
    "formattedAddress1",
...
public class PostalContactBillingAddress2
