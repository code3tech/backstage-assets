...
/**
 * An association cannot be created as the associated entity cannot be found. The key used to try to find the associated
 * entity is returned in the attributes of the exception.
 * :
 * :
 * null.
 * 
 * <p>Classe Java de AssociatedEntityNotFoundFaultInfo complex type.
 * 
 * <p>O seguinte fragmento do esquema especifica o conteúdo esperado contido dentro desta classe.
 * 
 * <pre>
 * &lt;complexType name="AssociatedEntityNotFoundFaultInfo"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "AssociatedEntityNotFoundFaultInfo", namespace = "http://amdocs/tef-vivo/core/types/v1", propOrder = {
    "entityTypeName",
    "keyValues"
})
public class AssociatedEntityNotFoundFaultInfo {

    protected String entityTypeName;
    protected AssociatedEntityNotFoundFaultInfo.KeyValues keyValues;
     ...
     * @return
     *     possible object is
     *     {@link AssociatedEntityNotFoundFaultInfo.KeyValues }
     *     
     */
    public AssociatedEntityNotFoundFaultInfo.KeyValues getKeyValues() {
        return keyValues;
    }
     ...
     *     
     */
    public void setKeyValues(AssociatedEntityNotFoundFaultInfo.KeyValues value) {
