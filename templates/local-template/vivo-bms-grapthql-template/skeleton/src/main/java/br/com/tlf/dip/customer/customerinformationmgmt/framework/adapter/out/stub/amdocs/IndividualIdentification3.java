...
@XmlType(name = "IndividualIdentification", namespace = "http://amdocs/tef-vivo/billingaccountmanagement/types/v1")
@XmlSeeAlso({
    NationalIdentityCardIdentification3 .class
})
public abstract class IndividualIdentification3 {
