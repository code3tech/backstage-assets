...
@XmlType(name = "CharacteristicID", namespace = "http://amdocs/tef-vivo/productcatalog-common/types/v1", propOrder = {
    "id"
})
@XmlSeeAlso({
    ConfigurableCharacteristicID2 .class
})
public abstract class CharacteristicID2 {
